image:https://github.com/mraible/jhipster-book/actions/workflows/Book%20CI/badge.svg[link="https://github.com/mraible/jhipster-book/actions",alt="Actions Status"]

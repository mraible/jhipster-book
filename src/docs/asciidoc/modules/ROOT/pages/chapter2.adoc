...
JHipster supports three UI frameworks: Angular, React, and Vue. In the first two versions of this book, I showed you how to use AngularJS. In the last three versions (4.0, 4.5, and 5.0), I showed you how to use Angular. Since this is a mini-book, I'm going to stick with showing Angular only. You can see from the following graphs that React and Angular are the most popular among JavaScript frameworks.
...
Angular 2.0 was released September 2016. Angular 4.0 was released March 2017. JHipster 4.6.0 was released July 6, 2017 and was the first release to contain production-ready Angular support. JHipster 7 uses Angular 14. Angular released version 15 during the production of this book.
...
todo: TypeScript syntax highlighting works in HTML and PDF, but not in EPUB. Need to fix this.
...
image::chapter2/bootstrap/basic-grid-desktop.png[Basic grid on desktop, 991, scaledwidth=100%]
...
image::chapter2/bootstrap/basic-grid-mobile.png[Basic grid on a mobile device, 768, scaledwidth=75%]
...
.Advanced grid
image::chapter2/bootstrap/advanced-grid-desktop.png[Advanced grid, 983, scaledwidth=100%]
...
.Basic form element
image::chapter2/bootstrap/basicelement.png[Basic form element, 712, scaledwidth=90%]
...
image::chapter2/bootstrap/basicelement-validation.png[Form element with validation, 712, scaledwidth=90%]
...
.Buttons
image::chapter2/bootstrap/buttons.png[Buttons, 754, scaledwidth=90%]
...
image::chapter2/bootstrap/navbar-with-dropdown.png[Navbar with dropdown, 956, scaledwidth=100%]
...
.Navbar on mobile
image::chapter2/bootstrap/navbar-on-mobile.png[Navbar on mobile, 476, scaledwidth=50%]
...
.Alerts
image::chapter2/bootstrap/alerts.png[Alerts, 776, scaledwidth=100%]
...
.Closeable alert
image::chapter2/bootstrap/alert-dismissable.png[Closeable alert, 830, scaledwidth=100%]
...
.Buttons with icons
image::chapter2/bootstrap/buttons-with-icons.png[Buttons with icons, 262, scaledwidth=25%]

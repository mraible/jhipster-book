...
[[img-spring-boot-2]]
.Spring Boot 2.0
image::chapter4/diagram-boot-reactor.svg[Spring Boot 2.0, 700, scaledwidth=100%, align=center]
...
This tutorial shows you how to build a microservices architecture with JHipster 7.9.3. You'll generate a gateway (powered by Spring Cloud Gateway), a blog microservice (that talks to Neo4j), a store microservice (that uses MongoDB), and use Docker Compose to make sure it all runs locally. I'll also provide some pointers on how to deploy it with Kubernetes.

...
jhipster
----
// todo: update screenshot and text for JHipster 7.8.2 (where ./gradlew -Pprod works)
ifeval::["{media}" != "prepress"]
...
// M1 Execution time: 3 min. 47 s. because https://github.com/cypress-io/cypress/issues/19908
----
...
I updated `application-prod.yml` to use `21points` for the datasource password. I shutdown the Docker image running PostgreSQL.
...
$ ./gradlew -Pprod
...
2022-05-01 21:15:02.117 ERROR 20608 --- [  restartedMain] com.zaxxer.hikari.pool.HikariPool        : Hikari - Exception during pool initialization.
...
Compressing objects: 100% (614/614), done.
Writing objects: 100% (648/648), 937.84 KiB | 12.50 MiB/s, done.
Total 648 (delta 82), reused 0 (delta 0), pack-reused 0
remote: Resolving deltas: 100% (82/82), done.
To github.com:mraible/21-point.git
...
// todo: start from here - git@github.com:mraible/21-points-v7.git
...
* https://github.com/twbs/bootstrap/blob/main/scss/_variables.scss can be overwritten here
...
[sidebar]
.How to use Material Design for Bootstrap 5 with JHipster 7
--
If you'd like to use https://fezvrasta.github.io/bootstrap-material-design/[Material Design for Bootstrap 5] with JHipster 7, that's possible too.

Below are the steps necessary to use Material Design for Bootstrap 5 and Sass:
...
TIP: If you want to see how how easy it is to use JDL-Studio, please see my https://www.youtube.com/watch?v=6lf64CctDAQ[Get Started with JHipster 7 Screencast].

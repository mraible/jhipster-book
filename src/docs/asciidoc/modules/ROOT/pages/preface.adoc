...
To try code samples, you will need a computer running an up-to-date operating system (Windows, Linux, or macOS). You will need Node.js and Java installed. The book code was tested against Node.js 16 and Java 11.

...
JHipster was started by Julien Dubois in October 2013 (Julien's first commit was on https://github.com/jhipster/generator-jhipster/commit/c8630ab7af7b6a99db880b3b0e2403806b7d2436[October 21, 2013]). The first public release (version 0.3.1) was launched December 7, 2013. Since then, the project has had over 110 releases! It is an open-source, Apache 2.0-licensed project on GitHub. It has a core team of 18 developers and over 325 contributors. You can find its homepage at https://jhipster.github.io/[https://jhipster.github.io]. Its https://github.com/jhipster/generator-jhipster[GitHub project] shows it's mostly written in JavaScript (40%), Java (29%), and HTML (15%). TypeScript is trailing in the fourth position with 13%.

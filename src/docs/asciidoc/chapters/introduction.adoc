...
JHipster was started by Julien Dubois in October 2013 (Julien's first commit was on https://github.com/jhipster/generator-jhipster/commit/c8630ab7af7b6a99db880b3b0e2403806b7d2436[October 21, 2013]). The first public release (version 0.3.1) was launched December 7, 2013. Since then, the project has had over 104 releases! It is an open-source, Apache 2.0-licensed project on GitHub. It has a core team of nine developers and over 230 contributors. You can find its homepage at http://jhipster.github.io/[http://jhipster.github.io]. Its https://www.openhub.net/p/generator-jhipster[Open HUB profile] shows it's mostly written in JavaScript and Java.

image::introduction/jhipster-openhub.png[Project Summary on Open HUB, 961, scaledwidth=80%, align=center]

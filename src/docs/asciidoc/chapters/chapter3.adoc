...
was removed when Gulp's popularity sky-rocketed. Gulp allows you to perform tasks like minification, concatenation,
compilation (e.g. from TypeScript/CoffeeScript to JavaScript), unit testing, and more.

Gulp calls itself the "`the streaming build system`". It's the de-facto standard of JavaScript build tools and has over

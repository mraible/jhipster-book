...
by enhancing the 'search.edit' state, we can look up the person from the SearchService before invoking the controller.
...
Now that you've learned about the hottest web framework on the planet, let's take a look at Bootstrap.

...
using on a few projects. To use it, you'll need to reference its JavaScript file (`angular-ui-router.min.js`) in
`index.html` instead of `angular-route.min.js`.
...
=== Grunt vs. Gulp.js
http://gruntjs.com/[Grunt] is _The JavaScript Task Runner_.

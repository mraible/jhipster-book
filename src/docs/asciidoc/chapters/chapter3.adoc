...
image::images/chapter3/angular/dice-jobs-march2013.png[Jobs on Dice in 2013, 450, scaledwidth="75%"]
[.left]
[[img-angular-skills-2013]]
.Skills on LinkedIn, March 2013
image::images/chapter3/angular/linkedin-skills-march2013.png[Skills on LinkedIn in 2013, 450, scaledwidth="75%"]
--
...
image::images/chapter3/angular/dice-jobs-february2014.png[Jobs on Dice in 2014, 450, scaledwidth="75%"]
[.left]
[[img-angular-skills-2014]]
.Skills on LinkedIn, February 2014
image::images/chapter3/angular/linkedin-skills-february2014.png[Skills on LinkedIn in 2014, 450, scaledwidth="75%"]
--
...
[[img-angular-mvc]]
.MVC in Angular
image::images/chapter3/angular/angular-mvc.png[MVC in Angular, 500, scaledwidth="75%", align=center]
...
TIP: To see the JavaScript console in Chrome, use kbd:[Command+Option+J] on Mac or kbd:[Ctrl+Shift+J] on Windows/Linux.
...
image::images/chapter3/bootstrap/basic-grid-desktop.png[Basic Grid on Desktop, 991, scaledwidth="100%"]
...
image::images/chapter3/bootstrap/basic-grid-mobile.png[Basic Grid on Mobile, 768, scaledwidth="75%"]
...
.Advanced Grid
image::images/chapter3/bootstrap/advanced-grid-desktop.png[Advanced Grid, 983, scaledwidth="100%"]
...
.Basic Form Element
image::images/chapter3/bootstrap/basicelement.png[Basic Form Element, 829, scaledwidth="90%"]
...
image::images/chapter3/bootstrap/basicelement-validation.png[Invalid Form Element, 829, scaledwidth="90%"]
...
.Buttons
image::images/chapter3/bootstrap/buttons.png[Buttons, 500, scaledwidth="55%"]
...
image::images/chapter3/bootstrap/navbar-with-dropdown.png[Navbar, 867, scaledwidth="100%"]
...
.Navbar on Mobile
image::images/chapter3/bootstrap/navbar-on-mobile.png[Navbar, 467, scaledwidth="50%"]
...
.Alerts
image::images/chapter3/bootstrap/alerts.png[Alerts, 828, scaledwidth="100%"]
...
.Closeable Alert
image::images/chapter3/bootstrap/alert-dismissable.png[Dismissable Alert, 830, scaledwidth="100%"]
...
.Buttons with icons
image::images/chapter3/bootstrap/buttons-with-icons.png[Buttons with icons, 241, scaledwidth="25%"]
...
glyphicons are the default and it's easy to change the font icons in your project. Simply add it as a dependency
...
==== Grunt
Grunt describes itself as _The JavaScript Task Runner_. It's the incumbent in the field of JavaScript build tools and has
over 4,000 http://gruntjs.com/plugins[plugins]. Grunt and Grunt plugins are installed and managed via https://www.npmjs.com/[npm],
a package manager for https://nodejs.org/[Node.js] and https://iojs.org/[io.js]. If it's specified as a dependency in
...
Grunt was created by Ben Alman and http://bocoup.com/weblog/introducing-grunt/[released to the public on March 29, 2012].

// http://gruntjs.com/plugins: 4,631
// http://gulpjs.com/plugins/: 1547

The following steps show you I integrated Grunt into https://github.com/angular/angular-seed[Angular Seed]. This particular
build file allows you to optimize your JS, CSS and HTML for production. It concatenates your JavaScript and CSS
files together, minifies them, then replaces the references in the HTML to point to the optimized files. First, you have
to configure `package.json` so it includes Grunt and its plugins for web optimization.
...
Before the tasks are run, the `index.html` file points to individual CSS and JavaScript files. The `<!-- build:* -\->`
...
After the build is run, the `dist/index.html` file points to the revved, combined and minified CSS and JavaScript files.
[source,html,linenums]
----
...
==== Gulp
Gulp describes itself as _The streaming build system_. Gulp is all about streams and building complex pipelines with ease.
It uses Node.js' streams, and executes faster, since it does not open/close files, or create intermediary copies. Gulp
was released a couple years after Grunt, but has received a lot of high praise from the JavaScript community.  In unison
with the UNIX philosophy, gulp plugins try to do one thing well.

To compare Gulp vs. Grunt, I integrated it into the Angular Seed project. Below are the `package.json` and `gulpfile.js`
...
so it's able to be a bit more nimble without the need for backwards compatibility. It also has a lot less
http://gulpjs.com/plugins/[plugins] (just over 1500 at the time of this writing). If you look at Google Trends for
"Grunt vs. Gulp", you'll see that Gulp received a lot of hype when it first came out, but now Grunt leads by a slight
margin.

[[img-bootstrap-advanced-grid-desktop]]
.Google Trends: Grunt vs. Gulp
image::images/chapter3/grunt+gulp/google-trends-grunt-vs-gulp.png[.Google Trends: Grunt vs. Gulp, 864, scaledwidth="100%"]
...
presentation. This presentation was delivered at MelbJS in Melbourne, Australia on 12 February 2014. I asked Mark
what he thought of these two tools today. He recommended http://webpack.github.io/[webpack] footnote:[Keith Circle
recommends you http://blog.keithcirkel.co.uk/why-we-should-stop-using-grunt/[don't use either tool and just use npm instead].] and his article
https://medium.com/seek-ui-engineering/block-element-modifying-your-javascript-components-d7f99fcab52b[Block, Element,
Modifying Your JavaScript Components]. Since webpack is not an option for JHipster, it will not be covered in this book.

If you're new to JavaScript build tools, I recommend using Grunt. You don't want to be overwhelmed with
too much new technology in your JHipster project if you're trying to meet a deadline. If you're using JHipster to learn
about a bunch of new technologies, then Gulp seems to be the hipper option.
...
This is covered in <<chapter4.websockets>>. The next section shows how a developer productivity tool that uses WebSockets
implements something very cool.
...
JHipster integrates BrowserSync for you, using JavaScript that looks very similar to what you see above. Integrating

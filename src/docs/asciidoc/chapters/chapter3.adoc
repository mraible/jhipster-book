...
the Node.js package manager. If its specified as a dependency in your project's `package.json`, you can install it
using `npm install`. To install it globally (so you can use it anywhere), run `npm install -g grunt-cli`.

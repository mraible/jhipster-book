...
image::chapter3/angular/indeed-jobs-aug2017.jpg[Jobs on Indeed, 762, scaledwidth=100%]
[.left]
...
a migration path for Angular 1.x users. They also adopted semantic versioning and [recommended people call it "Angular"
instead of Angular 2.0](http://angularjs.blogspot.com/2017/01/branding-guidelines-for-angular-and.html).

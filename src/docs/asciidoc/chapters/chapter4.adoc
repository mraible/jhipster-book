...
TIP: It's possible that JHipster will soon support four authentication options. JHipster Team member, Thibaut Mottet, has been working on integrating http://projects.spring.io/spring-social/[Spring Social] and has published a https://github.com/moifort/jhipster-app-social[sample application with Google and Facebook authentication].
...
https://www.mongodb.org/[MongoDB] was founded in 2007 by the folks behind DoubleClick, ShopWiki and Gilt Groupe. It is Apache and GNU-APGL licensed project on https://github.com/mongodb/mongo[GitHub]. It claims large customers like Foursquare, MTV, Forbes, GE Capital, Adobe, LinkedIn, eBay and eHarmony.
...
In addition to Facebook, Cassandra helps a number of companies achieve web-scale: CERN, Comcast, eBay, GitHub, GoDaddy, Hulu, Instagram, Intuit, Netflix, Reddit and The Weather Channel. They have some impressive numbers about scalability on their homepage.

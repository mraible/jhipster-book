...
A JHipster application can be deployed to your own JVM, https://jhipster.github.io/cloudfoundry/[Cloud Foundry], https://jhipster.github.io/heroku/[Heroku], https://jhipster.github.io/kubernetes/[Kubernetes], and https://jhipster.github.io/aws.html[AWS].

...
* *JWT authentication* — Like OAuth2, a stateless security mechanism. This is specific to JHipster, not provided by Spring Security. It uses the https://github.com/jwtk/jjwt[Java JWT project].
...
If you're familiar with RDBMS databases, I recommend you use PostgreSQL or MySQL for both development and production. PostgreSQL has great support on Heroku.

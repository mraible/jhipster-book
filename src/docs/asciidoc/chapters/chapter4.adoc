...
In August 2013, Phil Webb and Dave Syer, engineers at Pivotal,
...
projects for your company or team. You can find it on GitHub at https://github.com/spring-io/initializr[https://github.com/spring-io/initializr].
...
To show you how to create a simple application with Spring Boot, go to https://start.spring.io[https://start.spring.io] and select `Web`, `JPA`,
...
Spring Boot does a great job of auto-configuring libraries and simplifying Spring. JHipster complements that by
...
With Maven, you have one `pom.xml` file that's 986 lines of XML. With Gradle, you end up with several `*.gradle` files.
In the 21-Points project, their Groovy code adds up to only 583 lines.

////
build.gradle (243)
gradle.properties (27)
settings.gradle (1)
gradle/docker.gradle (75)
gradle/gatling.gradle (46)
gradle/graphite.gradle (3)
gradle/heroku.gradle (5)
gradle/liquibase.gradle (55)
gradle/mapstruct.gradle (5)
gradle/profile_dev.gradle (48)
gradle/profile_prod.gradle (55)
gradle/prometheus.gradle (5)
gradle/sonar.gradle (12)
gradle/zipkin.gradle (3)

243 + 27 + 1 + 75 + 46 + 3 + 5 + 55 + 5 + 48 + 55 + 5 + 12 + 3 = 583
////
...
TIP: JHipster's http://www.jhipster.tech/using-oracle/[Using Oracle] guide explains how'll you need an Oracle account to download its proprietary JDBC driver.
...
If you're familiar with RDBMS databases, I recommend you use PostgreSQL or MySQL for both development and production. PostgreSQL has great support on Heroku and MySQL has great support on AWS. JHipster's http://www.jhipster.tech/aws/[AWS sub-generator] has a limitation of only working with MySQL.
...
Cassandra http://www.jhipster.tech/using-cassandra/[does not support OAuth 2.0 authentication] and it requires you to run its migration tool manually, or in a Docker container.
****
...
https://http://www.jhipster.tech//development/[JHipster's development guide] recommends the following workflow:
...
A JHipster application can be deployed to your own JVM, http://www.jhipster.tech/cloudfoundry/[Cloud Foundry], http://www.jhipster.tech/heroku/[Heroku], https://http://www.jhipster.tech//kubernetes/[Kubernetes], and http://www.jhipster.tech/aws.html[AWS].

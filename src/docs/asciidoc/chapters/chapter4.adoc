...
After adding this code and restarting the application, you can curl [http://localhost:8080/blogs] or open it in your
favorite browser.
...
JHipster includes a plethora of Spring Boot starter dependencies by default. This allows developers right less code and worry
...
JHipster is hooking you up with a number of options to make your life easier!

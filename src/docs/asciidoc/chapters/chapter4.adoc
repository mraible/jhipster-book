...
If you're familiar with RDBMS databases, I recommend you use PostgreSQL or MySQL for both development and production. PostgreSQL has great support on Heroku and MySQL has great support on AWS. JHipster's https://www.jhipster.tech/aws/[AWS sub-generator] has a limitation of only working with MySQL.
...
Cassandra https://www.jhipster.tech/using-cassandra/[does not support OAuth 2.0 authentication] and it requires you to run its migration tool manually, or in a Docker container.
****

...
An in-depth and up-to-date book on Angular is https://www.ng-book.com/2/[_ng-book: The Complete Guide to Angular 4] by by Nathan Murray, Ari Lerner, Felipe Coury, and Carlos Taborda) (Fullstack.io, April 2017).

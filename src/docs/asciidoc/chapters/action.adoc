...
An in-depth and up-to-date book on Angular is https://www.ng-book.com/2/[ng-book: The Complete Guide to Angular 4] by by Nathan Murray, Felipe Coury, Ari Lerner, and Carlos Taborda) (Fullstack.io, April 2017).

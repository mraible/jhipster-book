...
TIP: You can also find this file [on GitHub](https://gist.github.com/mraible/3c97f60c6617e67fd87cd9895d54311c).
...
By default, the JHipster Registry will use Keycloak when running with Docker Compose. If you want to change it to use Okta, you'll need to modify `gateway/src/main/docker/jhipster-registry.yml` and change the default Keycloak settings to use your Okta settings, or environment variables (recommended).

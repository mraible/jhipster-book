...
After this completed, I opened up `src/main/webapp/index.html` and added links to the necessary CSS, just after bootstrap.css.

//TODO: Confirm all these needed to be added.
...
I also added the new JavaScript files (required by the theme) to the list of imported JavaScript files.

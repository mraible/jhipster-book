...
image::images/chapter2/points-list-before.png[Default Daily Points list, 1319, scaledwidth="100%", align="center"]

[[img-points-list-after]]
.Default Daily Points list after UI improvements
image::images/chapter2/points-list-after.png[Default Daily Points list after UI improvements, 1319, scaledwidth="100%", align="center"]
...
To finish things off, I added a link to use to a dialog where users could edit their preferences. I also added an appropriate state to allow editing in `main.js`.

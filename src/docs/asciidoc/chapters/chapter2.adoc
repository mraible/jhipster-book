...
.JHipster Upgrade Start
image::chapter2/jhipster-upgrade-start.png[Running the upgrade sub-generator, 1354, scaledwidth=100%, align=center]

[[jhipster-upgrade-end]]
.JHipster Upgrade End
image::chapter2/jhipster-upgrade-end.png[Running the upgrade sub-generator, upgraded, 1354, scaledwidth=100%, align=center]
endif::[]
ifeval::["{media}" == "prepress"]
[source%autofit]
----
$ git checkout -b jhipster-v5.3.0
Switched to a new branch 'jhipster-v5.3.0'
$ jhipster upgrade
...
5.3.0
Done in 1.24s.
✔ New generator-jhipster version found: 5.3.0
...
d279be92bb9e0481392946e4b2e98d2a4de06cc4
     info git checkout -q jhipster_upgrade
✔ Checked out branch "jhipster_upgrade"
Updating generator-jhipster to 5.3.0 . This might take some time...
     info yarn add generator-jhipster@5.3.0 --dev --no-lockfile --ignore-scripts
...
src/main/webapp/app/entities/blood-pressure/blood-pressure.route.ts
src/main/webapp/app/entities/blood-pressure/blood-pressure.service.ts
src/main/webapp/app/entities/points/points.route.ts
src/main/webapp/app/entities/points/points.service.ts
src/main/webapp/app/entities/weight/weight.service.ts
src/main/webapp/app/home/home.component.html
src/test/java/org/jhipster/health/web/rest/BloodPressureResourceIntTest.java
src/test/java/org/jhipster/health/web/rest/PointsResourceIntTest.java
src/test/java/org/jhipster/health/web/rest/PreferencesResourceIntTest.java
src/test/java/org/jhipster/health/web/rest/WeightResourceIntTest.java
...
src/test/javascript/e2e/entities/blood-pressure/blood-pressure.spec.ts
src/test/javascript/e2e/entities/points/points.page-object.ts
src/test/javascript/e2e/entities/points/points.spec.ts
src/test/javascript/e2e/entities/preferences/preferences.page-object.ts
src/test/javascript/e2e/entities/preferences/preferences.spec.ts
src/test/javascript/e2e/entities/weight/weight.page-object.ts
src/test/javascript/e2e/entities/weight/weight.spec.ts
src/test/resources/config/application.yml
webpack/webpack.dev.js

Congratulations, JHipster execution is complete!
Execution time: 2 min. 23 s.
----
endif::[]


After the command finished, I resolved conflicts, committed my changes, and ran `git push`. If you're reading this and notice that 21-Points Health is using a version newer than 5.3.0, it's likely because I used this handy sub-generator again.
...
After I finished developing the MVP of 21-Points Health with JHipster 5.3.0, I wanted to upgrade it to the latest release. I used the https://www.jhipster.tech/upgrading-an-application/[upgrade sub-generator], and upgraded it to 5.x.x. You can see what changed when I upgraded by taking a look at https://github.com/mraible/21-points/commit/4571d2c1a31fcbeb820417ea0f6d3f2364bb8e7e[the commit on GitHub].

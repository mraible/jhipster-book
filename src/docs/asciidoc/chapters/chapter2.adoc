...
The amount of code I had to write in each language was 561 lines of TypeScript, 687 lines of TypeScript, and 351 lines of HTML. The other 481 lines were JSON (135), XML (187), Sass (80), YAML (54), CSS (12), Markdown (6), Groovy (4), and Bourne Shell (3).

...
<<Deploy It!>> section of this chapter.

*[red]#Question: As noted above, I did my first deployment to Heroku at this time, rather than at the end. However, I think
readers are more interested in setting how the application was implemented. Would it be better to leave the deployment
section at the end of this chapter, or move it to here?#*
...
I tailed my log files with `heroku logs --tail` to make sure everything started up OK. I was quickly disappointed when
...
After making this change, I repacked and redployed. This time, when I tried to register, I recived an error when JHipster's

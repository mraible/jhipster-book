...
I started using the https://jhipster.github.io/installation/[Installing JHipster] instructions. I'm a Java developer,
...
TIP: If you need to install Java, Maven, or Git, please see https://jhipster.github.io/installation/[JHipster's local installation documentation].
...
I ran `yo jhipster:heroku` as recommended in the https://jhipster.github.io/heroku/[Deploying to Heroku]
...
JHipster 4.5.3 fixes this issue, so I upgraded using the https://jhipster.github.io/upgrading-an-application/[upgrade sub-generator].
...
https://jhipster.github.io/heroku/[deploying to Heroku]. It also has a handy sub-generator to generate the config files
...
I tried using the https://jhipster.github.io/upgrading-an-application/[upgrade sub-generator], but found that it was broken in 4.5.3
https://jhipster.github.io/2017/06/23/jhipster-release-4.5.6.html[and only fixed in 4.5.6]. Therefore, I manually upgraded 4.5.3 to 4.6.2 using
http://www.syntevo.com/smartsynchronize/[SmartSynchronize]. You can see what changed when I upgraded by taking a look
at [the commit on GitHub](https://github.com/mraible/21-points/commit/4571d2c1a31fcbeb820417ea0f6d3f2364bb8e7e).

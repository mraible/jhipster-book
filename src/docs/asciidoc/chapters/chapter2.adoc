...
[[img-ui-mockup]]
.UI Mockup
image::chapter2/ui-mockup.png[Simple Entity Diagram, 846, scaledwidth="50%", align="center"]
...
image::chapter2/entity-diagram-simpler.png[21-Point Health Entity Diagram - Simplified, 684, scaledwidth="75%", align="center"]

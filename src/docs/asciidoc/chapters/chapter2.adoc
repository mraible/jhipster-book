...
immediately and make progress quickly - especially when you're using dual monitors with <<BrowserSync>>. Below is a consolidated list of changes
I made to the HTML to make things look better.
...
.Default Points List
image::chapter2/points-list-before.png[Default Points List, 1319, scaledwidth="100%", align="center"]

[[img-points-list-after]]
.Points List After UI Improvements
image::chapter2/points-list-after.png[Points List After UI Improvements, 1319, scaledwidth="100%", align="center"]
...
image::chapter2/homepage-points-this-week.png[Points this week progress bar, 1381, scaledwidth="100%", align="center"]
...
image::chapter2/homepage-bp-last-30-days.png[Blood Pressure Last 30 Days Chart, 1338, scaledwidth="100%", align="center"]
...
* karma:zone
* unit test for main
* integration test to create user, add points
* Setup a build and deploy job on Jenkins.
* Show load testing with Gatling

=== Deploy it!

* Setup on Heroku, configured ElasticSearch and SendGrid for email.
...
api.heroku.com > app > Add-Ons > Heroku Postgres :: Gray > Reset Database

2015-08-19T09:02:09.975017+00:00 heroku[web.1]: Error R10 (Boot timeout) -> Web process failed to bind to $PORT within 60 seconds of launch

Submitted ticket to Heroku Support: Please increase timeout to 120 seconds
...
2015-08-20T15:11:41.395945+00:00 heroku[router]: at=info method=POST path="/api/register?cacheBuster=1440083497301" host=www.21-points.com request_id=500b6ed7-4359-4270-a38a-2ec6979facd4 fwd="50.170.188.22" dyno=web.1 connect=1ms service=3999ms status=201 bytes=339

...
I started using the https://www.jhipster.tech/installation/[Installing JHipster] instructions. I'm a Java developer,
so I already had Java 8 installed, as well as Maven and Git. I installed Node.js from https://nodejs.org/[Nodejs.org], Yarn using https://yarnpkg.com/en/docs/install[its instructions], then ran the following command to install JHipster.
...
----
{
  "generator-jhipster": {
    ...
    "jwtSecretKey": "085df706b054e1db67afbae8cf2c649b7e8e880d",
...
(node:49754) [DEP0022] DeprecationWarning: os.tmpDir() is deprecated. Use os.tmpdir() instead.
[15:47:19] W/configParser - pattern ./e2e/entities/**/*.spec.ts did not match any files.
[15:47:19] I/launcher - Running 1 instances of WebDriver
[15:47:19] I/direct - Using ChromeDriver directly...
Started
...........


11 specs, 0 failures
Finished in 25.126 seconds

[15:47:48] I/launcher - 0 instance(s) of WebDriver still running
[15:47:48] I/launcher - chrome #01 passed
✨  Done in 31.24s.
----
...
----------------------------------------------------------
        ...
        External:       http://192.168.0.121:8080
        Profile(s):     [prod]
----------------------------------------------------------
----
...
JHipster will initialize Git for your project automatically if you have Git installed. All I had to do to push to Bitbucket was

The following commands show how I added a reference to the remote Bitbucket repository, then pushed everything. I created the repository on Bitbucket before executing these commands.
...
Counting objects: 512, done.
Delta compression using up to 8 threads.
Compressing objects: 100% (483/483), done.
Writing objects: 100% (512/512), 608.64 KiB | 7.08 MiB/s, done.
Total 512 (delta 54), reused 0 (delta 0)
...
https://www.jhipster.tech/setting-up-ci-jenkins2/[Setting up Continuous Integration on Jenkins 2].
...
https://www.jhipster.tech/modules/marketplace/[JHipster Marketplace] and found the
https://www.jhipster.tech/modules/marketplace/#/details/generator-jhipster-bootstrap-material-design[Bootstrap Material Design]
...
https://www.jhipster.tech/creating-an-entity/[entity sub-generator]. The entity sub-generator is a command-line tool
that prompts you with questions which you answer. https://www.jhipster.tech/jdl-studio/[JDL-Studio] is a browser-based
tool for defining your domain model with JHipster Domain Language (JDL). Finally, https://www.jhipster.tech/jhipster-uml/[JHipster-UML]
...
I ran `jhipster entity points`. I added the appropriate fields and their validation rules, and specified a many-to-one
...
directory and ran `jhipster entity` for each entity again. This seemed easier than refactoring with IntelliJ and hoping
...
<div class="row">
    ...
    <div class="col-sm-4 text-right">
        <button class="btn btn-primary float-right jh-create-entity create-points"
...
I ran `jhipster heroku` as recommended in the https://www.jhipster.tech/heroku/[Deploying to Heroku]
...
JHipster 4.5.3 fixes this issue, so I upgraded using the https://www.jhipster.tech/upgrading-an-application/[upgrade sub-generator].
...
JHipster has good documentation on https://www.jhipster.tech/setting-up-ci-jenkins2/[setting up CI on Jenkins 2] and
https://www.jhipster.tech/heroku/[deploying to Heroku]. It also has a handy sub-generator to generate the config files
needed for Jenkins. I ran `jhipster ci-cd` and watched the magic happen.
...
I tried using the https://www.jhipster.tech/upgrading-an-application/[upgrade sub-generator], but found that it was broken in 4.5.3
https://www.jhipster.tech/2017/06/23/jhipster-release-4.5.6.html[and only fixed in 4.5.6]. Therefore, I manually upgraded 4.5.3 to 4.6.2 using
...
latest release of JHipster and how to generate code with `jhipster entity`. You learned how to do test-first development

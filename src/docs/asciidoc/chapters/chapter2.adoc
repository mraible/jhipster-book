...
ifndef::backend-epub3[<<Browsersync>>.] // LN: Any way to get rid of the square brackets in the rendered version?
...
----
====
// LN: I think this looks better as a block quote, as follows. Delete the one you don't want.
.Filtering by method
****
I later learned how do do the filtering in in the database by adding the following method to `BloodPressureRepository.java`:
